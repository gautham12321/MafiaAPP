        ...
        )
        {
            ...
            Counter(currentValue = settings.totalP.toInt(), size = 50.dp,
                onIncrease = {
                    ...
                    else{ Toast.makeText(context, "Minimum 4 players", Toast.LENGTH_SHORT).show()
                    }
                    })
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                ...
                                contentDescription = it.role.name, contentScale = ContentScale.Fit, modifier = Modifier.padding(10.dp).size(100.dp)
                            )
                            Counter(
                                currentValue = it.no,
                                size = 40.dp,
                                onIncrease =
                                {
                                    if(totalRoles < settings.totalP) {
                                        ...
                                        Toast.makeText(context, "Player Count Exceeded", Toast.LENGTH_SHORT).show()
